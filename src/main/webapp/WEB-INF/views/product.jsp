      ...
      <div class="row s_product_inner">
        ...
        <div class="col-lg-5 offset-lg-1">
          ...
          <div class="s_product_text">
            ...
            <span style="color: #777777; text-decoration: line-through;"><fmt:formatNumber value="${product.price}" type="number"></fmt:formatNumber></span>
            <h2 id="priceArea">
            ￦<fmt:formatNumber value="${product.salePrice}" type="number"></fmt:formatNumber>
            </h2>
            <ul class="list">
              <li>
          ...
          <div class="s_product_text">
            <h3>${product.productNm}</h3>
            <h2 id="priceArea">
            ￦<fmt:formatNumber value="${product.price}" type="number"></fmt:formatNumber>
            </h2>
            <ul class="list">
              <li>
                <a class="active" href="/product/list/${product.categoryCd}">
			...
			success:function(data){
				...
				if(jsonComment.length > 0){
					for(i=0; i<jsonComment.length; i++){
		                ...
		                htmlComment += "<hr><div class='review_item' id='user_review_"+commentId+"'><div class='media'>";
		                htmlComment += "<div class='media-body'><h4>"+jsonComment[i].email+"</h4>";
