							...
							<div class="col-lg-4 col-md-4 mb-4">
								<div class="card h-100">
									...
									<div class="card-body">
										...
										<h5>
											<span style="color: #FF0000;"><fmt:formatNumber value="${list.salePrice}" type="number"></fmt:formatNumber>원</span>
										</h5>
									...
									<div class="card-footer">
										...
										<c:choose>
											<c:when test="${list.ratingAvg !=0.00}">
												<b style="color:#EBE028;">&#9733;</b><fmt:formatNumber value="${list.ratingAvg}" pattern="0.00"></fmt:formatNumber>
											</c:when>
											<c:otherwise>
