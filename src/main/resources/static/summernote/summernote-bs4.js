...
(function (global, factory) {
  ...
  var buttonGroup = renderer.create('<div class="note-btn-group btn-group" style="margin-top:0px">');
  ...
  var ui = {
      ...
      button: function ($node, options) {
          return renderer.create('<button type="button" class="note-btn btn btn-light btn-sm" role="button" tabindex="-1" style="padding: 0px 8px">', function ($node, options) {
  ...
  var AutoLink = /** @class */ (function () {
      ...
      AutoLink.prototype.handleKeydown = function (e) {
          if (lists.contains([key.code.ENTER, key.code.SPACE], e.keyCode)) {
              ...
              const alreadyHasHref = wordRange.nativeRange().endContainer.parentElement.hasAttribute('href'); // added
              this.lastWordRange = alreadyHasHref? null: wordRange; // changed
          }
      };
